...
const Slider = ({ children, sliderCount }) => {
  ...
  return (
    <div className='slider rounded-lg flex justify-center items-center flex-col h-[60vh] lg:h-[70vh] max-w-[1140px] mx-auto relative'>
      ...
      <div className='flex justify-center items-center gap-3 absolute bottom-[30px] right-[30px] '>
